...
int Sum2Numb (int a, int b)
{
    int s=0;
    s=a+b;
    return s;
}
int Dif2Numb (int a, int b)
{
    int c=0;
    c=a-b;
    return c;
...
float ADividedByB (float a, float b)
{
    float c=1;
    c=a/b;
    return c;
}
float Fractions (float a, float b, float c, float d)
{
    float n1,n2;
    n1=a/b;
    n2=c/d;
...
int PerfectSquareInterval (int a,int b)
{
    int i,k=0;
    for(i=a; i<=b; i++)
    {
...
int PrimeNumberInterval (int a,int b)
{
    int i,k=0;
    for(i=a; i<=b; i++)
    {
...
int main()
{
    ...
    if(check1==1)
    {
        ...
        if(check2==3) //PALINDROM
        {
            ...
            if(Palindrom(n)== true)
            {
                cout<<"The mirrord number of "<<n<<" is "<<MirrorNumber(n)<<" so it's a palindrom "<<endl;
            }
            else
            {
                cout<<"The mirrord number of "<<n<<" is "<<MirrorNumber(n)<<" so it's not a palindrom "<<endl;
            }
        }
    }
    if(check1==2)
    {
        ...
        if(check3==2)
        {
            ...
            cout<<"Write your number here : ";
            cin>>n;
            cout<<"The maximum digit of "<<n<<" is "<<DigitMax(n)<<endl;
        }
        if(check3==3)
        {
            float n;
            cout<<"Write your number here : ";
            cin>>n;
            cout<<"The minimum digit of "<<n<<" is "<<DigitMin(n)<<endl;
        }
        if(check3==4)
        {
            float n;
            cout<<"Write your number here : ";
            cin>>n;
            cout<<"The number has "<<HowManyEvenNumb(n)<<" even digits "<<endl;
        }
        if(check3==5)
        {
            float n;
            cout<<"Write your number here : ";
            cin>>n;
            cout<<"The number has "<<HowManyOddNumb(n)<<" odd digits "<<endl;
        }
    }
    if(check1==3)
    {
        ...
        if(check4==5)
        {
            ...
            cout<<"d=";
            cin>>d;
            if(Fractions(a,b,c,d)==1)
            {
                cout<<a<<"/"<<b<<" is bigger than "<<c<<"/"<<d<<endl;
            }
            if(Fractions(a,b,c,d)==2)
            {
                cout<<a<<"/"<<b<<" is smaller than "<<c<<"/"<<d<<endl;
            }
            if(Fractions(a,b,c,d)==3)
            {
    ...
    if(check1==4)
    {
        ...
        if(check5==1)
        {
            ...
            cout<<"b=";
            cin>>b;
            cout<<"The sum of natural numbers between a and b is "<<SumInterval(a,b)<<endl;
        }
        if(check5==2)
        {
            float a,b;
            ...
            cout<<"b=";
            cin>>b;
            cout<<"The number of perfect squares between a and b is "<<PerfectSquareInterval(a,b)<<endl;
        }
        if(check5==3)
        {
            float a,b;
            ...
            cout<<"b=";
            cin>>b;
            cout<<"The number of prime numbers between a and b is "<<PrimeNumberInterval(a,b)<<endl;
        }
    }
    if(check1==5)
    {
